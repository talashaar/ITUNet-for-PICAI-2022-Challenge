...
def main():
    ...
    predict_test5c(
        weight_path=supervised_weights_dir / 'classification_output_without_adc/ckpt/picai/v0/', #classification
    ...
    outdir = workdir / 'segout/segmentation_result_without_adc'
    save_npy(
        data_path=data_path,
        ckpt_path_base=supervised_weights_dir / 'segmentation_without_adc/ckpt/seg/',
