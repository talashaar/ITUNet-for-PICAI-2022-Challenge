...
def main():
    ...
    predict_test5c(
        weight_path=supervised_weights_dir / 'step1_classification_full_4folds' / 'ckpt/picai/v0/',
    ...
    save_npy(
        data_path=data_path,
        ckpt_path_base=supervised_weights_dir / 'step2_segmentation_full_4folds' / 'ckpt/seg/',
